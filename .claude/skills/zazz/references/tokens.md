...
`packages/core/src/base/_variables.css` (global Tiers 1–3) and each
`packages/core/src/primitives/{name}/{name}.css` (component tokens, Tier 4) — read those when you need an
