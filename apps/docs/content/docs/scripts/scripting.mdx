...
| `carousel.js`       | `embla.js`                 | `<slide-carousel>` custom element              |
| `lightbox.js`       | `carousel.js`              | `<media-lightbox>` custom element              |
| `password-group.js` | None                       | `<input-password>` custom element              |
| `tabs.js`           | None                       | `<tab-group>` custom element                   |
