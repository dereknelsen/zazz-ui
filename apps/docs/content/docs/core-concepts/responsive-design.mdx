...
Prefix layout utilities with `@sm:`, `@md:`, `@lg:`, `@xl:`, or `@2xl:`. These apply style queries against centralized page breakpoint flags published by the `body` container:
...
<div class="flex flex-col @lg:flex-row gap-md">...</div>
```
