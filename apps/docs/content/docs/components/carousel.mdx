...
Enable plugins with a space-separated `data-carousel-plugins` list. Configure each plugin with its option prefix — options alone do not load the plugin.

```html
<ui-carousel
  data-carousel-plugins="autoplay"
  data-carousel-autoplay-delay="3000"
>
  ...
</ui-carousel>
```
