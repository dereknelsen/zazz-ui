...
| ----------------------- | -------------------------- | ------------------------------------------------- |
| `data-reveal-duration`  | `--reveal-global-duration` | Animation duration                                |
| `data-reveal-wait`      | `0`                        | Base delay before starting (ms)                   |
| `data-reveal-step`      | `80`                       | Delay step between children (ms)                  |
| `data-reveal-ease`      | `--reveal-global-ease`     | Timing function                                   |
...
:root {
  ...
  --reveal-global-grow: 0.97;
  --reveal-global-shrink: 1.03;
}
```
