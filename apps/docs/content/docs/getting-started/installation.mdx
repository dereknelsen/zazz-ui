...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/@zazz-ui/ui/src/primitives/dialog/dialog.css"
/>
```
...
pnpm dlx degit dereknelsen/zazz-ui/packages/ui/src/primitives/dialog ./zazz/primitives/dialog
```
