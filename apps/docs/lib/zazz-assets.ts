...
import { WEB_COMPONENT_SCRIPT_FILES, type ExampleScript } from "@zazz-ui/core/manifest";
 ...
 * inside the installed `@zazz-ui/core` package (resolved by `lib/zazz-package.ts`).
 *
