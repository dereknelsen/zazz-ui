...
| Path          | What it is                                                                                                                                                                                   |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/ui` | [`@zazz-ui/ui`](packages/ui) — the kit itself (not yet published; see [Publishing](#publishing)). CSS + HTML + TS-authored scripts, co-located per component under `src/primitives/<name>/`. |
